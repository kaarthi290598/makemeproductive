      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="mt-6 text-4xl font-black tracking-tight text-slate-900 dark:text-white sm:text-6xl md:text-7xl"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-sm font-medium text-slate-600 dark:text-slate-300 sm:text-base md:text-lg"
          >
          ...
          >
            <SignedOut>
              <Link href="/sign-up">
                <Button className="h-12 gap-2 rounded-2xl bg-emerald-600 px-6 text-sm font-bold text-white shadow-xl shadow-emerald-600/30 transition-all hover:bg-emerald-500 hover:shadow-emerald-600/40 active:scale-95 sm:h-13 sm:px-8">
              ...
              <a href="#features">
                <Button
                  variant="outline"
                  className="h-12 rounded-2xl border-slate-200 bg-white/80 px-6 text-sm font-bold text-slate-700 shadow-sm backdrop-blur-md hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900/80 dark:text-slate-200 dark:hover:bg-slate-800 sm:h-13"
                >
                  Explore 6 Modules
                </Button>
              </a>
          ...
          <motion.div
            ...
            className="mt-8 flex flex-wrap items-center justify-center gap-5 text-xs font-semibold text-slate-500 dark:text-slate-400"
          >
        ...
        >
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200/90 bg-white/70 p-4 shadow-2xl backdrop-blur-2xl dark:border-slate-800/80 dark:bg-slate-900/60 sm:p-6 lg:p-8">
