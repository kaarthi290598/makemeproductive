...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      {/* Material 3 Drag Handle Pill for Mobile Bottom Sheet */}
      <div className="mx-auto -mt-2 mb-1 h-1.5 w-12 shrink-0 rounded-full bg-slate-300 dark:bg-slate-700 sm:hidden" />
      {children}
